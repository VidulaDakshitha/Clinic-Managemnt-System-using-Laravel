...
<table class="table table-hover table-responsive-block">
    ...
    <tr>
                    ...
                    <td scope="row" style="width:90%">
                        <div class="row">
                            <div class="col-xs-4">
                                <img style="padding:10%"class="img-circle mini-profile-pic p-t-10" alt=""
                                     src="/images/doc.png">
                            ...
                            <h5 class="semi-bold">{{$post->fullname}}</h5>
                                ...
                                <p class="no-margin text-uppercase pv">Urologist</p>

                                <p class="pv">Lanka Hospitals </p>
...
ABOVE.PLEASE DO NOT ACCEPT PENDING APPOINTMENTS
    "> --}}
                            ...
                            <input type="submit" onclick="ShowProgressAnimation();" class="btn btn-danger btn-sm" value="Book Now">
