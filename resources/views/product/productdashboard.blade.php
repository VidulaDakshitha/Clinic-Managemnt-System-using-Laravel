...
@section('title', 'Product Management')
    ...
    <link rel="stylesheet" href={{ url('css/product/vendors/bootstrap/dist/css/bootstrap.min.css') }}>  
    <link rel="stylesheet" href={{ url('css/product/ors/font-awesome/css/font-awesome.min.css') }}>   
    <link rel="stylesheet" href={{ url('css/product/vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}>   
