                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="menu">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="{{ url('paymentHome')}}" style="color:#62a832;">HOME</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="header-text">
                            ...
                            <p>You are able make online payments for your medicines, medical consume items and doctor
                                appoinments.
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="another-text">
                            ...
                            <p>As IHHR, we provide you to pay by card or bank slip <br> on special circumstances you may
                                raise request to refund it </p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-form">
                            <form action="{{ route('card.store')}}" method="POST">
                                ...
                                <div class="last">
                                    ...
                                    <input type="text" id="orderID" name="orderID" value={{$latsorderid}}>
                                </div>
                                <div class="first">
                                    <input type="text" id="cardNum" name="cardNum" placeholder="Card Number"
                                        pattern="[0-9]{4} *[0-9]{4} *[0-9]{4} *[0-9]{4}"
                                        title="ERROR: Card number should contain 16 numbers" required>
                                </div>
                                <div class="last">
                                ...
                                <div class="first">
                                    <input type="text" id="serialNum" name="serialNum"
                                        placeholder="Serial 3-digits(xxx)" pattern="[0-9]{3}"
                                        title="ERROR: Card serial should contain 3 numbers only" required>
                                </div>
                                <div class="last">
                                    <input type="text" id="cardType" name="cardType"
                                        placeholder="Card Type(VISA or MASTER)" pattern="(VISA)||(MASTER)" required>
                                </div>
                                ...
                                <div class="checkbox-submit">
                                    <div class="checkbox">
                                        <label><input type="checkbox" name="" required> Agree for terms &
                                            condition</label>
                                    </div>
                                    <div class="submit">
                            ...
                            <button onclick="myFunction1()" class="btn btn-primary">Demo1</button>


                            <script>
                                function myFunction() {
                                                document.getElementById("orderID").value = "O2";
                                ...
                                function myFunction1() {
                                                document.getElementById("orderID").value = "A1";
                                                document.getElementById("cardNum").value = "1234123412341234";
                                                document.getElementById("bank").value = "Sampath";
                                                document.getElementById("serialNum").value = "123";
                                                document.getElementById("cardType").value = "VISA";
                                                }
                            </script>
